...
class ExperimentalController: UIViewController {
...
extension ExperimentalController: UITableViewDataSource, UITableViewDelegate {
...
extension ExperimentalController: UIScrollViewDelegate {
